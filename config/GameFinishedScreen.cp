#line 1 "E:/University of New Haven/Semester 2/Embedded Systems/Project 3/3C/Objective 2/GameFinishedScreen.c"
...
#line 3 "E:/University of New Haven/Semester 2/Embedded Systems/Project 3/3C/Objective 2/GameFinishedScreen.c"
void GameFinishedScreen(){
 TIM3_CR1 = 0x0000;
 TIM1_CR1 = 0x0000;
 ...
 TFT_Write_Text("You Finished the Game",  320  / 2 - 70,  240  / 2);
 TFT_Write_Text("Click the Joystick to Reset the Game",  320  / 2 - 110,  240  / 2 + 30);
 Sound_Play(100, 2000);
}
