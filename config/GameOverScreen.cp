#line 1 "E:/University of New Haven/Semester 2/Embedded Systems/Project 3/3C/Objective 2/GameOverScreen.c"
...
#line 3 "E:/University of New Haven/Semester 2/Embedded Systems/Project 3/3C/Objective 2/GameOverScreen.c"
char score1;
char score0;
...
void GameOverScreen(){
 ...
 TFT_Write_Text("Your score is",  320  / 2 - 55,  240 / 15  * 5);
 score1 = score/10 + 48;
 score0 = score%10 + 48;
 TFT_Write_Char(score1, 320  / 2 + 30,  240 / 15  * 5);
 TFT_Write_Char(score0, 320  / 2 + 40,  240 / 15  * 5);
 TFT_Write_Text("Click the Joystick to Reset the Game",  320  / 2 - 110,  240  / 2);
